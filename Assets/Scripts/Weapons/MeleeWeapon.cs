...
{
    [SerializeField]
    private GameObject _attackPoint; // Point that will be a center of hit circle
    ...
    public override void Attack()
    {
        ...
        {
            Collider2D[] hittedEnemyes = Physics2D.OverlapCircleAll(_attackPoint.transform.position, _attackRange, _enemyLayer);
